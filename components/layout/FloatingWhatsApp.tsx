    ...
    <AnimatePresence>
      {show && (
        ...
        >
          ...
          <span className="relative flex h-14 w-14 items-center justify-center rounded-full bg-[#25D366] shadow-[0_12px_40px_-8px_rgba(37,211,102,0.7)]">
            <svg
              viewBox="0 0 24 24"
              className="h-7 w-7 fill-[#06210f]"
              aria-hidden
            >
